...
export default function AffiliatePage() {
  ...
  return (
    ...
    <>
    <head>
        <title>Afíliate a DXN en Ayacucho - Beneficios Exclusivos y Oportunidades</title> {/* Título optimizado */}
        <meta name="description" content="Únete a DXN Ayacucho y disfruta de beneficios exclusivos. Afíliate hoy y sé parte de nuestra red de éxito en productos de bienestar y salud." /> {/* Descripción optimizada */}
        <meta name="keywords" content="Afiliación DXN, DXN Ayacucho, Beneficios DXN, Cómo afiliarse a DXN, Productos DXN" /> {/* Palabras clave */}
        <meta name="robots" content="index, follow" /> {/* Permitir indexación */}
        <meta property="og:title" content="Afíliate a DXN en Ayacucho" /> {/* Optimización para redes sociales */}
        <meta property="og:description" content="Únete a nuestra red y disfruta de beneficios exclusivos." />
        <meta property="og:url" content="https://dxnayacucho.vercel.app/afiliacion" />
        <link rel="canonical" href="https://dxnayacucho.vercel.app/afiliacion" /> {/* Enlace canónico apuntando a la página específica */}
      </head>
      ...
      <div className="container md:py-36 mx-auto py-28 flex flex-col lg:flex-row items-start lg:items-start gap-8">
        ...
        <div id="join" className="lg:w-1/2 mb-8 lg:mb-0 px-1">
          ...
          <p className="text-gray-800 mb-2 dark:text-slate-100">
              <strong>Email:</strong>{" "} 
              <a href="mailto:u19217724@gmail.com" className="underline dark:text-slate-100" onClick={openMailClient} rel="noopener noreferrer">
                u19217724@gmail.com
              </a>
            </p>
          <p className="text-gray-800 mb-2 dark:text-slate-100">
